...
using OnlineTestForCLanguage.Identity;
using OnlineTestForCLanguage.MultiTenancy;
using OnlineTestForCLanguage.Sessions;
using OnlineTestForCLanguage.Web.Models.Account;
using OnlineTestForCLanguage.Web.Views.Shared.Components.TenantChange;

namespace OnlineTestForCLanguage.Web.Controllers
{
    public class AccountController : OnlineTestForCLanguageControllerBase
    {
